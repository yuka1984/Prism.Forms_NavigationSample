...
namespace XFApp2
{
    ...
    /// </summary>
    public abstract class CustomPageNavigationService : INavigationService, IPageAware
    {
        ...
        async Task ProcessNavigation(Page currentPage, Queue<string> segments, NavigationParameters parameters, bool? useModalNavigation, bool animated)
        {
            ...
            else if (currentPage is TabbedMasterDetailPage)
            {
                await
                    ProcessNavigationForTabbedMasterDetailPage((TabbedMasterDetailPage)currentPage, nextSegment,
                        segments, parameters, useModalNavigation, animated);
            }
        ...
        async Task ProcessNavigationForTabbedMasterDetailPage(TabbedMasterDetailPage currentPage, string nextSegment, Queue<string> segments,
    NavigationParameters parameters, bool? useModalNavigation, bool animated)
        {
            var nextSegmentType = PageNavigationRegistry.GetPageType(UriParsingHelper.GetSegmentName(nextSegment));
            foreach (var child in currentPage.Children)
            {
    ...
    public class UnityCustomPageNavigationService : CustomPageNavigationService
    {
